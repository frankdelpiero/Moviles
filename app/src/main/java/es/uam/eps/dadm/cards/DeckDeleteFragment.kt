...
import es.uam.eps.dadm.cards.databinding.*
 ...
 */
class DeckDeleteFragment : Fragment() {
    ...
    private lateinit var binding:FragmentDeckDeleteBinding
    private val viewModel by lazy {
        ViewModelProvider(this).get(DeckDeleteViewModel::class.java)
    }
    override fun onStart() {
        ...
        binding.deckNameChange.addTextChangedListener(deckNameTextWatcher)
        //
        binding.acceptDeckDeleteButton.setOnClickListener{
           // deck.name = name
            executor.execute{
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        binding = DataBindingUtil.inflate<FragmentDeckDeleteBinding>(
                inflater,
                R.layout.fragment_deck_delete,
                container,
                false)
        //val args = DeckDeFragmentArgs.fromBundle(requireArguments())
        //deckId = args.idMazo
